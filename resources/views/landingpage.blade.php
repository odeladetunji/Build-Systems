...
<body>
        <div>
        	...
        	<div class="row aboutUs">
        		<h3>Who We are</h3>
        		<p>we ara bla bla bla ....</p>

        		<h3>Our Technologies</h3><br>
        		...
        		<h3 id="lastH3">Mission</h3><br><br>
        		<p>to make life easier for people....</p><br>
        		<h3>Our Partners</h3>
        		<div class="imagesDiv">
        			<img src="/storage/images/google.png" alt="" class="images">
        			<img src="/storage/images/aws.png" alt="" class="images">
        			<img src="/storage/images/digitaloceans.png" alt="" class="images">
        			<img src="/storage/images/namecheap.png" alt="">
        		</div>
        	</div>
        	<div class="row footer">
        		<form action="">
        			...
        			<textarea name="" id="" cols="30" rows="10" placeholder="please enter your quest below and we will get back to you"></textarea>
        			<button>submit!</button>
        		</form>
        		<p>Copyright @buildsystems inc 2018</p>
        	</div>
        </div>
</body>
</html>
...
<body>
        <div>
        	...
        	<div class="row headBanner">
        		...
        		<h1>Build Systems Inc.</h1>
        		<h1>Automate Systems,</h1>
        		<p>Design, Create, impliment and Automate any industrial or business process. Whatever task your organisation or company do everyday in a repetitive manner, we will automate it with algorithms to foster greater productivity in your endeavours</p>
        		<button>Contact</button>
        	</div>
        	<div class="howWeAutomateProcess">
        		<h2>How We Automate Process,</h2>
        	</div>
        	<div class="row">
        		<div class="col-4-sm info">
        			<div>
        				<i class="icom"></i>

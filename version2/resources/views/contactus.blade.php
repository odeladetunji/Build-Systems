  ...
  <body>
    ...
    <div class="contactBanner">
      <div class="forDetails">
        <h3>Contact Us</h3>
        <h3>Get in touch, let us know <br>how we can help actualize <br>your dreams</h3>
        <div class="contactDetails">
            <i class="fas fa-map-marker-alt"></i>
            <p>1A, Wole Ariyo Streat, Admiralty Way, <br> Lekki Phase 1, Lagos. Nigeria.</p>
        </div>
        <div class="contactDetails">
            <i class="fas fa-envelope"></i>
            <p>info@buildsystems.io</p>
        </div>
        <div class="contactDetails">
            <i class="fas fa-phone"></i>
            <p>+ 234 (809) 999 3021</p>
        </div>
      </div>
      <img src="{{ asset('/images/BuildSystem/ContactUs/ContactUsImg.png')}}">
    </div>
    <div class="forMap" style="background-image: url({{ asset('/images/BuildSystem/ContactUs/map.png')}})">
    </div>
